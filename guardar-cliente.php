...
if (isset($_POST['guardar_cliente'])) {
    ...
    {
        $query = "INSERT INTO personas(dni, nombre, apellidos, direccion,tel,pais,departamento,cod_postal,correo,rol,provincia,fecha_nacimiento) VALUES ('$dni', '$nombre','$apellidos','$direccion','$tel','$pais','$departamento','$cod_postal', '$correo', 'cliente','$provincia','$fecha_nacimiento')";
