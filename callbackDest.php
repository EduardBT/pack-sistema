...
<h3 class="text-primary" style="margin-top:15px">Datos del destinatario:</h3><br>
<form>
    <div class="row">
...
<?php echo '<a href="editar-cliente.php?regreso=remitente' . '&id=' . $row['id_persona'] . '"><button type="button" class="btn btn-outline-primary"><i class="bi bi-arrow-counterclockwise"
                        style="margin-right:10px">Modificar Datos</button></a>'; ?>