...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE personas set dni = '$dni', nombre = '$nombre', apellidos='$apellidos', direccion='$direccion', pais='$pais', departamento='$departamento', cod_postal='$cod_postal', tel='$tel', correo='$correo' WHERE id_persona = $id";
...
<div class="card container  full-screen shadow" style="margin-top:5%">
    <form class="form-horizontal" method="POST" action="editar-cliente.php?id=<?php echo $_GET['id']; ?>"
        autocomplete="off">
        <div class="form-group">
            <div class="row">
                <h2 style="margin-bottom: 10px;"><i class="bi bi-pencil-square" style="margin-right:15px"></i>EDITAR
                    CLIENTE</h2>
                <hr>
