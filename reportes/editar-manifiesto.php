  ...
  <div class="table-responsive">
    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        $query = " SELECT distinct id_guia, personasEnv_id,cod_destino,personasDest_id, tipo_bulto, fecha_emb, cantidad_bulto, peso_real, numero, peso_volumetrico, electronico FROM guia_embarque  WHERE cod_origen=$cod_origen AND cod_destino=$cod_destino and estado_id=1 and electronico='$elec'  ";
